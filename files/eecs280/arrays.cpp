...
void add(char arr[], int size, int val){
    F(i, 0, size){
        arr[i] = (arr[i] + (val % ASCII_PRINTABLE_RANGE) < MIN_PRINTABLE_ASCII) ? (arr[i] + (val % ASCII_PRINTABLE_RANGE) + ASCII_PRINTABLE_RANGE) : ((arr[i] + (val % ASCII_PRINTABLE_RANGE) > MAX_PRINTABLE_ASCII) ? (arr[i] + (val % ASCII_PRINTABLE_RANGE) - ASCII_PRINTABLE_RANGE) : (arr[i] + (val % ASCII_PRINTABLE_RANGE)));
